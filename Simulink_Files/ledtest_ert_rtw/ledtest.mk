###########################################################################
## Makefile generated for Simulink model 'ledtest'. 
## 
## Makefile     : ledtest.mk
## Generated on : Thu Oct 18 16:08:19 2018
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ledtest.elf
...
MODELREF_LINK_RSPFILE_NAME = ledtest_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ledtest.elf
...
DEFINES_STANDARD = -DMODEL=ledtest -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = MW_espeak.c MW_led.c ledtest.c ledtest_data.c ext_svr.c updown.c ext_work.c rtiostream_utils.c linuxinitialize.c rtiostream_interface.c rtiostream_tcpip.c
...
OBJS = MW_espeak.c.o MW_led.c.o ledtest.c.o ledtest_data.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
